...
// ============================================================================
// OAuth API key resolution from ~/.repi/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".repi", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.repi/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.repi/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".repi", "agent");

/**
 * Get an AuthStorage instance backed by ~/.repi/agent/auth.json
